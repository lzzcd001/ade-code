...
class CustomizedAdamOptimizer(optimizer.Optimizer):
  ...
  def __init__(self, learning_rate=0.001, beta1=0.9, beta2=0.999, epsilon=1e-8,
    ...
    Args:
      ...
      name: Optional name for the operations created when applying gradients.
        Defaults to "Adam".
    """
    super(CustomizedAdamOptimizer, self).__init__(use_locking, name)
  ...
  def _apply_dense(self, grad, var):
    ...
    clip_bounds = 3 * tf.sqrt(v / (1 - self._beta2_power)) + 0.1   
